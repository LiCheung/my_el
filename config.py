...
#CCKS_DIR = path.join(RAW_DATA_DIR, 'mel')
CCKS_DIR = './rawdata'
CCKS_TRAIN_FILENAME = path.join(CCKS_DIR, 'Train.txt')
CCKS_TEST_FILENAME = path.join(CCKS_DIR, 'Test.txt')
CCKS_TEST_FINAL_FILENAME = path.join(CCKS_DIR, 'eval722.json')
KB_FILENAME = path.join(CCKS_DIR, 'twitterKB.json')
M2E_FILENAME = path.join(CCKS_DIR, 'm2e.json')
...
ENTITY_ID_FILENAME = 'entity_id.pkl'
